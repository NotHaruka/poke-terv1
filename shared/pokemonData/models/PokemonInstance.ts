...
export interface MonsterSpecies {
  ...
  evolutions: LegacyEvolutionRequirement[];
}

export enum LegacyGrowthRate {
  Fast = 0,
  MediumFast = 1,
  MediumSlow = 2,
  Slow = 3,
...
export interface LegacyEvolutionRequirement {
...
export enum LegacyMoveCategory {
  Physical = 0,
  Special = 1,
  Status = 2,
}
...
export enum LegacyItemCategory {
  Medicine = 0,
  CaptureDevice = 1,
  Berry = 2,
  Held = 3,
