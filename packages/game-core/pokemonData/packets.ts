...
import { PlayerProfile, PlayerData, BattleEnvironmentData } from './models/PokemonInstance.js';
...
export type BattleActionData =
  | { kind: 'attack'; moveIndex: number; moveId?: number; targetId?: string; isMega?: boolean }
  | { kind: 'switch'; slot: number; targetId?: string }
  | { kind: 'item'; itemId: number; targetId?: string }
  | { kind: 'run'; targetId?: string };
