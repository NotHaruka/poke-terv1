...
import { WORLD_SEED, TOWN_CHUNK_SPACING, CHUNK_SIZE, TILE_SIZE } from '../../game-core/pokemonData/data/Constants.js';
import { NPCDefinition, Vec2, Direction } from '../../game-core/pokemonData/models/PokemonInstance.js';
...
export function isWalkableTileId(tileId: number): boolean {
  ...
  switch (tileId) {
    case TILE_GRASS: defId = 'grass_flat'; break;
    case TILE_TALL_GRASS: defId = 'tall_grass'; break;
    case TILE_WATER: defId = 'water_open'; break;
    case TILE_PATH: defId = 'path_dirt'; break;
    case TILE_TREE: defId = 'tree_canopy'; break;
    case TILE_MOUNTAIN: defId = 'cave_wall_brown'; break;
    case TILE_BUILDING_FLOOR: defId = 'building_facade'; break;
    case TILE_BUILDING_WALL: defId = 'building_facade'; break;
    case TILE_DOOR: defId = 'door_entrance'; break;
    case TILE_PORTAL: defId = 'door_entrance'; break;
    default: defId = 'grass_flat'; break;
  }
