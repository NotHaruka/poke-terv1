import { BattleAdapter } from "./integration/BattleAdapter.js";
import { EncounterIntegration } from "./integration/EncounterIntegration.js";
import { WebSocket } from 'ws';
import { ClientState, MapInstance } from './types.js';
import { AnyPacket, findSafeSpawn, WORLD_SEED, getBiomeAt, rawTerrainTile, BattleEnvironmentData } from '@game-core/pokemonData.js';
import { TradeManager } from './TradeManager.js';
import { PokemonSpawnManager } from './PokemonSpawnManager.js';
...
export class GameState {
  ...
  public spawnManager: PokemonSpawnManager;
  public battleAdapter: BattleAdapter;
  public encounterIntegration: EncounterIntegration;
